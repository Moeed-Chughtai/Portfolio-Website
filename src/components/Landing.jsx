        ...
        <div className="mt-40 text-secondary flex justify-center">
            ...
            <a href="https://github.com/Moeed-Chughtai">
                <svg
                    ...
                    className="feather feather-github text-lighter hover:text-secondary w-6 h-6 fixed left-17 bottom-68">
                    <title>GitHub</title>
            ...
            <a href="https://www.linkedin.com/in/moeed-chughtai/">
                <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-linkedin text-lighter hover:text-secondary w-6 h-6 fixed left-17 bottom-56">
            ...
            <a href="https://medium.com/@moeed.chughtai">
                <svg
                    ...
                    className=" text-lighter hover:text-secondary w-6 h-6 fixed left-17 bottom-44">
                    <title>Medium</title>

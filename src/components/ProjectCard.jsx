...
export default function ProjectCard(props) {
    ...
    return (
        <div className="flex sm:flex-row flex-col bg-gray-900 rounded-lg shadow-lg mt-10 p-6 w-full transition duration-300 ease-in-out transform hover:scale-105 relative">
            <div className="flex flex-col w-full mr-6">
                <div className="flex justify-between items-start">
                    ...
                    <a href={props.link} target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 transition duration-300 ease-in-out transform hover:scale-105 hover:text-secondary">
            ...
            <div className="relative w-full flex justify-center items-center">
                ...
                <button
                    className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gray-800 text-gray-300 hover:text-gray-400 transition duration-300 ease-in-out p-2 rounded-full z-10"
                    onClick={prevImage}
                >
                    &lt;
                </button>
                <button
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-800 text-gray-300 hover:text-gray-400 transition duration-300 ease-in-out p-2 rounded-full z-10"
                    onClick={nextImage}
                >
                    &gt;
                </button>

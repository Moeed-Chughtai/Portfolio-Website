...
export default function Hackathons() {
    ...
    return (
        <ScrollTrigger onEnter={onEnterViewport}>
            <div id="hackathons" className={`mt-10 sm:mt-40 text-secondary flex justify-center ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transition: 'opacity 1s ease-out, transform 2s ease-out' }}>
